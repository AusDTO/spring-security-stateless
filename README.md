...
Then add the dependency:
    ...
    dependencies {
        ...
        compile 'com.github.AusDTO:spring-security-stateless:1.2.1'
    }
...
[Javadoc](https://jitpack.io/com/github/AusDTO/spring-security-stateless/v1.2.1/javadoc/index.html)
